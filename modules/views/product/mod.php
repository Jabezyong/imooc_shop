...
//                                echo $form->field($model, 'descr')->textarea(['id' => "wysi", 'class' => "span9 wysihtml5", 'style' => 'margin-left:120px']);
                                ...
                                ?>
                                    <img src="<?php echo 'pics/' .$model->productid .'/'. $model->cover?>" class="img-rounded" alt="Cinque Terre" width="304" height="236">
                                ...
                                ?>
                                    <img src="<?php echo 'pics/' .$model->productid .'/'. $pic?>" class="img-rounded" alt="Cinque Terre" width="304" height="236">
